...
EndDataSection
  ...
  Global download$ = "QmWvFtr8N9XvYPhSRL53DFVMKeZ1yqn5bgLfsMCTWfowmQ"
  Global md5$="522b7a6ec0950453afcc39ab893b043a"
  Global saveas$="AudioVideo_To_Exe.exe"
  Global title$="Downloading - Audio/Video To Exe v2.1"
  Global size=32458112
  Global link$
  Global *mem
  Global ok
...
Procedure Save()
  ...
  s$=SaveFileRequester("Save as...", GetPathPart(ProgramFilename()) + saveas$,"EXE (*.exe)|*.exe",0)
